...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Objeto de taxas de câmbio fixas para o conversor de moedas
    ...
    document.addEventListener('keydown', (event) => {
        ...
        if (key === 'Enter' || key === '=') {
            ...
            if (activeTabId === 'padrao') {
                ...
                switch (activeTabId) {
                    case 'porcentagem':
                        // Tenta identificar o botão de "Valor é qual %" se o foco estiver em um de seus inputs [cite: 52]
                    ...
                    case 'imc': targetButtonId = 'btn-calc-imc'; break; // [cite: 61]
                    case 'gorjeta': targetButtonId = 'btn-calc-gorjeta'; break; // [cite: 107]
                    case 'juros': targetButtonId = 'btn-calc-juros'; break; // [cite: 112]
                    case 'combustivel': targetButtonId = 'btn-calc-combustivel'; break; // [cite: 121]
                    case 'data': targetButtonId = 'btn-calc-data'; break; // 
                    case 'moedas': targetButtonId = 'btn-calc-moedas'; break; // [cite: 149]
                }
    ...
    if(btnCalcMoedas) {
        btnCalcMoedas.addEventListener('click', () => {
            ...
            if (!taxa) {
                 alert('Erro: Moeda de origem não suportada nas taxas fixas.');
                 return;
            }
